...
Java_com_audiopro_djmrec_audio_AudioEngine_setProtocolTracing(JNIEnv*, jobject, jboolean enabled) {
    djmrec::setProtocolTracing(enabled);
}
extern "C" JNIEXPORT jstring JNICALL
Java_com_audiopro_djmrec_audio_AudioEngine_drainProtocolTrace(JNIEnv* env, jobject) {
    return env->NewStringUTF(djmrec::drainProtocolTrace().c_str());
}
