...
**A separate LAN connection is the supported implementation path. DJM-A9 USB-only track metadata is unverified.**
...
- UDP 50001: beats and mixer on-air/control messages. Not required by this first implementation; no control messages are sent.
